            ...
            <MaxWidthWrapper>
                <div className="mx-auto max-w-2xl sm:text-center">
                    ...
                    <p className="mt-6 text-base/7 text-gray-600 max-w-prose text-center text-pretty">
                        ...
                        That's why we offer limetime access to PingPanda for a
                        one-time payment.
                    </p>
                </div>
                <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                    <div className="p-8 sm:p-10 lg:flex-auto">
                        ...
                        <p className="mt-6 text-base/7 text-gray-600">
                            Invest once in PingPanda and transform how you monitor you SaaS forever. Get
                            instant alerts, track critical metrics and never
                        ...
                        <ul className="mt-8 grid grid-cols-1 gap-4 text-sm/6 sm:grid-cols-2 sm:gap-6">

        ...
        <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
            ...
            <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
                ...
                <div className="flex-1 overflow-y-auto pt-4">
                    ...
                    <div className="px-2 mb-4">
                        <h3 className="text-xs font-semibold text-[#839297] px-2 mb-2 uppercase">
                            Direct Messages
                        </h3>
                        ...
                        <div className="my-1 space-y-px">
                            {[...Array(4)].map((_, i) => (
                                <div key={i} className="flex items-center px-2 py-1.5 text-gray-600 cursor-not-allowed">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="p-4">
                    <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                        ...
                        <input placeholder="Message @PingPanda" className="flex-1 bg-transparent py-2.5 text-white placeholder-[#72767d] focus:outline-none cursor-not-allowed" readOnly />
